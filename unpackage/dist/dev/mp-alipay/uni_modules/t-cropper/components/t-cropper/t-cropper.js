...
const _sfc_main = {
  ...
  `;
    ...
    const confirmWx = () => {
      ...
      common_vendor.index.createSelectorQuery().select("#canvas-cropper").fields({
        node: true,
        size: true
      }).exec(async (res) => {
        ...
        textCanvas.toTempFilePath({
          ...
          fail: (err) => {
            common_vendor.index.__f__("log", "at uni_modules/t-cropper/components/t-cropper/t-cropper.vue:516", err);
          }
        });
        common_vendor.index.hideLoading();
      });
    ...
    const moveImage = (ta, tb) => {
      ...
      let my2 = tb.clientY - ta.clientY;
      origin.bgImage.left = move.start.bgImage.left + mx;
      origin.bgImage.top = move.start.bgImage.top + my2;
...
//# sourceMappingURL=../../../../../.sourcemap/mp-alipay/uni_modules/t-cropper/components/t-cropper/t-cropper.js.map
